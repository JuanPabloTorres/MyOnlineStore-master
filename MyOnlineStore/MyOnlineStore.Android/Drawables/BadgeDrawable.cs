...
namespace MyOnlineStore.Droid.Drawables
{
    public class BadgeDrawable : Drawable
    {
        ...
        public BadgeDrawable(Context context, Color backgroundColor, Color textColor)
        {
            ...
            _context = context;
            float textSize = context.Resources.GetDimension(Resource.Dimension.notification_right_icon_size);//original
        ...
        public override void Draw(Canvas canvas)
        {
            ...
            float radius = ((Java.Lang.Math.Max(width, height) / 2.0f)) / 2.0f;
